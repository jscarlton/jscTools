#' I will eventually create my own theme out of this, but for now it's a thinly disguised version of Kieran Healy's Myriad theme.
#' @title theme_fira
...
#' # seminal bar chart
#'
#' update_geom_font_defaults(family=font_fira_light)
#'
#' count(mpg, class) %>%
#'   ggplot(aes(class, n)) +
#'   geom_col() +
...
#' }
theme_fira <- function(base_family="Fira Mono", base_size = 12,
                         title_family = "Fira Sans",
                         plot_title_family = title_family, plot_title_size = 18,
                         ...
                         axis_title_family = title_family, axis_title_size = 12,
                         axis_title_face = "plain", axis_title_just = "ct",
  ...
  ret <- ret + ggplot2::theme(legend.title=ggplot2::element_text(size=legend_title_size,
                                                                 family=legend_title_family, face=legend_title_face))
